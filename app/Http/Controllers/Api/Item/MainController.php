...
class MainController extends BaseController
{
    ...
    )
    {
        ...
        if (!$item) {
            return $this->respondWithError('Не удалось найти товар.');
        }
        ...
        return $this->respondWithSuccess([],'Данные товара успешно обновлены.');
    }
    ...
    )
    {
        ...
        return $this->respondWithSuccess([],'Товар успешно удален.');
    }
}
